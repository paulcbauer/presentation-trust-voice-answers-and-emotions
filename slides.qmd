...
- [Audio Survey Responses]{style="color:blue"}: What insights can we gain by leveraging spoken responses in surveys to understand respondents' views more deeply?

- [Emotion Analysis]{style="color:blue"}: What insights can we gain through automated emotion analysis of audio responses, and how do emotions influence political trust dynamics?

- [Political Trust]{style="color:blue"}: How can we measure political trust? And how can we use Audio Data and Emotion Analysis to support this task?
