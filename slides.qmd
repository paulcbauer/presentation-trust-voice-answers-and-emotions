...
subtitle: '<h3>Vortragsreihe "Politik in Europa", 18 June 2024</h3><br><br>'
author:
  - name: Dr. Camille Landesvatter
    affiliations:
...
- 1. [**Audio Data in the Social Sciences and in Surveys**]{style="color:blue"}: What insights can we gain by leveraging spoken (audio) responses in surveys?

- 2. [**Emotion Analysis**]{style="color:blue"}: What insights can we gain through automated emotion analysis of audio responses?

- 3. [**Paper**]{style="color:blue"}: Affect and Emotions in Political Trust
...
- [Revilla et al. 2020]{style="color:blue"}: Speaking requires less effort than typing and voice formats make survey answering easier/quicker (barriers!).
:::
...
- Increasing number of methods to analyze audio data (Computer Science, Computational Linguistics, Computational Social Science)
...
::: fragment
- **Speech Emotion Recognition (SER)** is part of the field of Automated Emotion Recognition (intersect with disciplines such as Neurocomputing, Affective Computing) 
:::

::: fragment
- Evolution of Models from traditional Machine Learning models (e.g., logistic regression) to methods based on deep learning/neural networks, e.g. SpeechBrain (Ravanelli et al. 2021)
:::
...
1. **Substantive debate**: Rational reasoning vs. affective states
	- Lahno (2020): Game-theory &rarr; rational choice assumptions & risk calculations & social trust
...
2. **Today's relevance of emotions**
	- Changing media environment &rarr; emotions (fear, anger/rage) used to influence people (and their trust), e.g., by providing emotionally arousing content such as immgrants' crime (Gabriel et al. 2023)
<br><br>
...
- "**Automatic Hot Cognition**" (Lodge and Taber 2013): all sociopolitical concepts that have been evaluated in the past are affectively charged &rarr; affective charge is automatically activated within milliseconds on mere exposure to the concept
<br><br>

- **H1:** Open-ended survey answers to the question about the reasons for respondents’ trust include both non-neutral sentiment **(H1a)** as well as emotional, i.e., non-neutral language **(H1b)**
- **H2:** The sentiment or emotion expressed in an open-ended survey answer is correlated with the closed-ended trust score
...
- Associations with a positive sentiment positively influence trust scores, and vice versa
	- → Associations with the question wording and thought processes matter.
...
- Sentiment is related to trust judgments, but no consistent effect of emotions (only happiness)
- NLP/AI introduces new opportunities for measurement

::: fragment
Limitations and follow-up questions:

- Other probing wordings; Small response rates (33%); Discrete emotions; Combine text & audio/sound; 
:::
::: fragment
- Survey setting not emotion enough? What is the setting?
:::
::: fragment
